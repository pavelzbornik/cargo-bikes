...
| **Motor**             | Bosch Performance Sport Gen 3, 65Nm, mid-drive |
| **Battery**           | Bosch PowerPack 500Wh, removable, 2.6kg        |
| **Range**             | 50-135km (varies by assist and load)           |
...
| **Max Assist Speed**  | 25 km/h (28 mph in USA)                        |
| **Charging Time**     | 4.5 hours (500Wh battery)                      |
| **Guarantee**         | 5 years frame, 2 years electrical              |

## E-bike Features

- **Motor**: Bosch Performance Sport Gen 3 with 65Nm torque for reliable hill climbing
- **Assist Levels**: 5 modes via Bosch Purion display (Eco, Tour, Sport, eMTB, Turbo)
- **Max Support Level**: 300%
- **Battery**: Removable Bosch 500Wh; 2.6kg; no memory effect
- **Charging**: 4.5 hours full charge (2A charger)
- **Display**: Bosch Purion on-board computer with intuitive controls
...
- **Weather Resistance**: Sealed connectors and weatherproof components
- **Modular Design**: Etility® platform for flexible cargo configurations
- **Smartphone Compatibility**: Optional Bosch Cobi Air or Kiox display upgrade
...
- **Family Transport**: Ideal for carrying two children and groceries
- **Urban Commuting**: Practical for daily city transport with reliable Bosch motor
- **Delivery**: Suitable for urban courier and small business use
- **Weekend Adventures**: Capable of longer day trips with moderate cargo
...
- **Motor**: Sealed Bosch Performance Sport Gen 3 requires routine maintenance only:
...
- **Tires**: Schwalbe Super Moto X 27.5" x 2.4"
  ...
  - Puncture repair kit should always be carried
...
- **Technical Documentation**:
  - Bosch Performance Sport Gen 3 motor specifications
...
- **Related Resources**:
  ...
  - Authorized service center locator (via Ovelo/Benno)
