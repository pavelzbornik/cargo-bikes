...
The Yepp 2 Maxi offers premium passenger seating for young children, combining comfort, safety, and ease of use. As a universal accessory from a dedicated child seat brand, it is not tied to any single bike manufacturer, making it a versatile choice across multiple cargo bike platforms.

## Features

- Padded, ergonomic seat shell for child comfort on longer rides
- 5-point safety harness for secure restraint
- Adjustable footrests and shoulder straps to accommodate growing children
- Compatible with MIK (Mounting Is Key) carrier systems and standard rear racks
- Quick-release mounting for easy removal and reinstallation
...
The Yepp 2 Maxi is manufactured by Yepp, an independent accessory brand, and is sold separately from any specific cargo bike. It is not a proprietary accessory of any single bike brand. Buyers should confirm rack compatibility with their specific bike model prior to purchase.
