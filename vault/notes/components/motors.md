...
This guide explains the two main motor types found on cargo bikes in this vault, compares the major brands, and helps you match a motor to your real-world needs.
...
A mid-drive motor sits at the heart of the bike, right where you pedal (the "bottom bracket"). It works with your gears, meaning it can deliver power efficiently whether you're climbing a steep hill in a low gear or cruising on a flat road in a high gear.
...
## Understanding Watts and Newton-Metres

You'll see two numbers used to describe motors:

- **Watts (W)** — This is the motor's power output. Think of it like the size of an engine. More watts generally means more top-end speed assistance and better performance under heavy load.
- **Newton-metres (Nm)** — This is torque, which is the twisting force the motor applies. High torque means the motor feels strong and responsive when you first push the pedals — especially useful when starting from a standstill with a loaded bike, or when climbing hills.

For family cargo bikes, **torque often matters more than watts**. A 250W motor with 85Nm will feel much more capable on hills than a 250W motor with 40Nm.

---

## Motor Brand Overview
...
## Which Motor Is Right for Your Family?

**You live somewhere hilly and carry heavy loads**
Look for high torque: the Bafang m400 (110Nm), Naka E-Power Max (100Nm), Specialized 2.2 Cargo (90Nm), or any of the Bosch/Shimano 85Nm motors will give you the strongest assist when you need it most.

**You want a well-known, supported brand**
Bosch and Shimano have wide dealer networks and long track records. Bosch's Cargo Line and CX motors, and Shimano's EP8 and EP6 Cargo, are both proven choices for family cargo bikes.

**You mostly ride flat urban routes**
A 250W, 50Nm motor (like the Bosch Active Plus or Gaya hub motors) may be perfectly adequate and can help keep costs down.

**You want maximum power**
The Aventon Direct Drive Hub Motor (750W) and Bosch Performance Line Gen5 (600W) lead the vault on raw wattage. These are good choices if you want a strong, effortless feeling across all conditions.

**You're on a tighter budget**
Bafang motors offer strong torque (the m400 hits 110Nm) at a generally lower price point than Bosch or Shimano. Worth considering if the motor specs meet your needs.
